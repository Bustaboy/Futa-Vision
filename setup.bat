...
if not defined PYTHON_CMD (
    ...
    echo.
    echo Python 3.13+ is intentionally blocked until the pinned NumPy/MoviePy/OpenCV
    echo video stack publishes compatible wheels and metadata. During installation, check
